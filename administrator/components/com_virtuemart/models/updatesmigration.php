...
class VirtueMartModelUpdatesMigration extends VmModel {
	...
	$fields['title'] =  'Sr';
	$fields['last_name'] =  'Juan';
	$fields['first_name'] =  'Perez';
	$fields['middle_name'] =  '';
	$fields['phone_1'] =  '834-100-01-01'; 
	$fields['address_1'] =  'Calle Benito Jaurez #1801';
	$fields['city'] =  'Victoria';
	$fields['zip'] =  '87090';
	$fields['virtuemart_state_id'] =  '104';
	$fields['virtuemart_country_id'] =  '138';
